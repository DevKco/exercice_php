...
<html lang="en">
    ...
    <body>
        ...
        foreach ($resultat_articleFiche as $rlt) {
            ?>
        <!-- Product section-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                       ...
                       <?php 
                        ...
                        if (!empty($_SESSION['id_user'])) {
                            ...
                            if (mysqli_num_rows($table_vote) > 0) {
                                echo " cet utilisateur à déja voté";
                                echo "";
                        ...
                        if (!empty($_POST)) {
                            if ($_POST["vote"] < 1 || $_POST["vote"] > 5) {
                                ...
                                echo "Le vote à bien été pris en compte";
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center"> 
                    ...
                    foreach ($resultat_article as $key_allarticles) { ?>
                        <?php if ($key_allarticles['id_article'] != $_GET['id_article']) { 
                            ?>
                            <?php 
                            $inc = 0;
                            foreach ($resultatCommentsAllArticles as $key_vote => $value_vote)
                                ...
                                if($value_vote['id_article'] == $key_allarticles['id_article']){
                                    ...
                                    $key_allarticles['commentaire'][$inc] = $value_vote;
